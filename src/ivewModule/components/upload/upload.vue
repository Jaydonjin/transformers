<template>
  <div :class="[prefixCls]">
    <Row>
      ...
      <Col span="1">
      <div class="panel middle_panel"></div>
      </Col>
      <Col span="11" class="upload_list">
      <upload-list
        v-if="showUploadList"
        :files="fileList"
  ...
  export default {
    ...
    methods: {
      ...
      post (file) {
        ...
        //Expand (Jayodn.t.Jin) fileName too long
        if (file.name.length > 100) {
          this.onNameError(file, this.fileList);
          return false
        }
...
//                    action: this.action,
      ...
      handleStart (file) {
        ...
        // (Jaydon)fix: change in array type
